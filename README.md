...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C057%20rows-8250df">
...
> **Important:** this repository is a **public 9,057-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,097 domains** on the canonical page below.

**Public extract:** 9,057 rows · **Live catalog:** 5,622,097 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/vegas?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vegas_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/vegas?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vegas_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./vegas.csv">CSV</a> / <a href="./vegas.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_vegas_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_vegas_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .VEGAS search](https://unique.domains/domains/tld/vegas?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vegas_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .VEGAS search](https://unique.domains/domains/tld/vegas?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vegas_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./vegas.csv) or [Download JSON](./vegas.json)
...
- `vegas.csv` — public CSV extract (9,057 rows)
- `vegas.json` — public JSON extract (9,057 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,057-row public sample | 5,622,097 live domains                           |
...
| energy.vegas     | premium   | $260      | $129.94       | 82             | 46     | 6      | namecheap                                                        |
...
> Unique Domains. *Available .VEGAS One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
